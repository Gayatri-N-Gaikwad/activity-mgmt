          ...
          <tbody>
            ...
            <tr>
              ...
              <td style={{ padding: "8px 0" }}>
                {activity.coordinatorId?.name || "N/A"}
              </td>
            </tr>
            {activity.assignmentId && (
              <>
                <tr>
                  ...
                  <td style={{ padding: "8px 0" }}>
                    {activity.assignmentId?.year &&
                    activity.assignmentId?.division
                ...
                <tr>
                  ...
                  <td style={{ padding: "8px 0" }}>
                    {activity.assignmentId.subjectId?.name || "N/A"}
                  </td>
                </tr>
              </>
            )}
            ...
            {activity.conductedConfirmation && (
              <>
                <tr>
                  ...
                  <td style={{ padding: "8px 0" }}>
                    {new Date(
                      activity.conductedConfirmation.confirmedAt,
                ...
                <tr>
                  ...
                  <td style={{ padding: "8px 0" }}>
                    {activity.conductedConfirmation.confirmedBy?.name || "N/A"}
                  </td>
                </tr>
